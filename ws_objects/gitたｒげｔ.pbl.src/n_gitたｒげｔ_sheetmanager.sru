$PBExportHeader$n_gitたｒげｔ_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_gitたｒげｔ_sheetmanager from nonvisualobject
end type
end forward

global type n_gitたｒげｔ_sheetmanager from nonvisualobject
end type
global n_gitたｒげｔ_sheetmanager n_gitたｒげｔ_sheetmanager

type variables
string is_sheets[], is_display[]
w_gitたｒげｔ_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_gitたｒげｔ_basesheet aw_sheet)
...
li_rc = OpenSheet ( lw_sheet, as_sheetname, w_gitたｒげｔ_frame, 0, Cascaded! ) 
...
w_gitたｒげｔ_basesheet lw_sheets[], lw_init[]
...
//*-----------------------------------------------------------------*/
m_gitたｒげｔ_frame lm_menu
int li_i, li_max

lm_menu = w_gitたｒげｔ_frame.MenuId
...
w_gitたｒげｔ_sheet1	lw_sheet1
w_gitたｒげｔ_sheet2	lw_sheet2
w_gitたｒげｔ_sheet3	lw_sheet3
...
on n_gitたｒげｔ_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_gitたｒげｔ_sheetmanager.destroy
