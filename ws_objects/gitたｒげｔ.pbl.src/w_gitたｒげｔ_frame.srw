$PBExportHeader$w_gitたｒげｔ_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_gitたｒげｔ_frame from window
end type
type mdi_1 from mdiclient within w_gitたｒげｔ_frame
end type
end forward
...
string title = "フレーム"
string menuname = "m_gitたｒげｔ_frame"
...
global w_gitたｒげｔ_frame w_gitたｒげｔ_frame

type variables
n_gitたｒげｔ_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_gitたｒげｔ_basesheet aw_sheet)
public function long of_classcount (readonly w_gitたｒげｔ_basesheet aw_sheet)
public function integer of_adjustmenu (ref m_gitたｒげｔ_frame am_menu)
end prototypes
...
string ls_sheets[]  = { "w_gitたｒげｔ_sheet1", "w_gitたｒげｔ_sheet2", "w_gitたｒげｔ_sheet3" }
string ls_display[]  = { "無題 シート1", "無題 シート2", "無題 シート3" }
...
//*-----------------------------------------------------------------*/
long ll_job
w_gitたｒげｔ_basesheet lw_sheet

lw_sheet = this.GetActiveSheet ( )

If IsValid ( lw_sheet ) Then
	this.SetMicroHelp ( "アクティブなシートを印刷しています..." )
	ll_job = PrintOpen ( )
...
inv_sheetmgt = Create n_gitたｒげｔ_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_gitたｒげｔ_frame.create
if this.MenuName = "m_gitたｒげｔ_frame" then this.MenuID = create m_gitたｒげｔ_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_gitたｒげｔ_frame.destroy
